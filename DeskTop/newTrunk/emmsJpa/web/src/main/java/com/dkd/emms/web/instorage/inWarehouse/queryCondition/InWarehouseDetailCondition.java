package com.dkd.emms.web.instorage.inWarehouse.queryCondition;
 ...
 */
public class InWarehouseDetailCondition {
    /**
     *
     * 入库明细ID（系统生成）
     *
     ...
     *
     */
    private List<String> inWarehouseDetailList;
    /**
     *
     * 储位ID
     *
    ...
    public List<String> getInWarehouseDetailList() {
        return inWarehouseDetailList;
    }

    public void setInWarehouseDetailList(List<String> inWarehouseDetailList) {
