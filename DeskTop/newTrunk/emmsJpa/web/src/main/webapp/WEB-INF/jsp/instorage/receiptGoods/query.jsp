...
<body>
<div class="easyui-panel" title="首页->实物入库管理->物资收货->收货单查询" data-options="fit:true,border:false">
    <form id="query" method="post">
        ...
        <div style="text-align: center;">
            ...
            <a href="${emms}/instorage/receiptGoods.do?cmd=edit&receiptType=delivery&inStorage=receipt"
               iconCls='icon-add' class="easyui-linkbutton">新建发货单收货订单</a>
            <a href="${emms}/instorage/receiptGoods.do?cmd=edit&receiptType=order&inStorage=receipt" iconCls='icon-add'
               class="easyui-linkbutton">新建采购单收货订单</a>
        </div>
    </form>
            ...
            columns: [[
                {
                    ...
                    formatter: function (value, row, index) {
                        return '<a style="color:blue" href="${emms}/instorage/receiptGoods.do?cmd=view&receiptId=' + row.receiptId + '&receiptType=' + row.receiptType + '&inStorage=receipt">' + row.receiptCode + '</a>';
                    }
                },
                {
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        if (row.receiptState == 'dianshou') {
                            ...
                            + row.receiptId + "&inStorage=receipt&receiptType=" + row.receiptType
                            + "' target='_self'>点收</a>&nbsp;&nbsp;&nbsp;";
