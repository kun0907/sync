		...
		<div class="easyui-panel" title="首页->库存台账->库存明细查询" data-options="fit:true,border:false">
			<form id="query" method="post">
				<div style="margin:20px">
					...
					<input class="easyui-textbox" id="stockState" style="width:30%" data-options="label:'库存状态:'">
					<select class="easyui-textbox" id="storagelocationCode" style="width:30%" data-options="label:'储位编码:'"></select>
				</div>
				...
				$('#table').datagrid({
					...
					loadFilter: function(data) {
						...
						for (var i = 0; i < rows.length; i++) {
							...
							}else if(rows[i].stockState == 'outFinish'){
