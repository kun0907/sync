...
<body>
<div class="easyui-panel" title="首页->实物入库管理->直达质检管理->查看质检单" data-options="fit:true,border:false">
    ...
    <div>
        ...
        <table id="tableM" auto-resize="true" class="easyui-datagrid" title="质检单明细" style="width:100%;height:220px" >
        </table>
    </div>
        <div>
    ...
    <%--<div style="margin:5px;height:70px;" id="upload">--%>
        <%--<tr>--%>
            <%--<td>上传质检文件</td>--%>
            <%--<td width="5px;"></td>--%>
            <%--<td>--%>
                <%--<input class="easyui-filebox" id="excel" name="excel" data-options="prompt:'点击选择文件'" style="width:30%">--%>
            <%--</td>--%>
        <%--</tr>--%>
        <%--<table id="tableT" auto-resize="true" class="easyui-datagrid" title="">--%>
        <%--</table>--%>
    <%--</div>--%>
</div>
<script type="text/javascript">
    ...
    var dictionary = {};
    $(function(){
        $('#query').form('load', '${emms}/instorage/materialManag.do?cmd=loadDirectInspectData&materiaInspectId=${materiaInspectId}');
        $('#query').form({
        ...
        $('#tableT').datagrid({
            ...
            columns:[[
                ...
                {field:'realFileName',sortable:true,title:'图片名',align:'center',width:'80%'},
                {
        ...
        $('#tableM').datagrid({
            ...
            columns:[[
                ...
                {field:'productDate',sortable:true,title:'生产日期',align:'center',width:'8%'},
                {field:'qualityDate',sortable:true,title:'保质期',align:'center',width:'8%'},
