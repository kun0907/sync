...
<body>
<div class="easyui-panel" title="首页->实物入库管理->直达现场->收货单查看" data-options="fit:true,border:false">
  <form id="ff" method="post">
    ...
    <div style="padding:10px">
      <input class="easyui-combobox" id="receiptOrgId" name="receiptOrgId"  style="width:30%" data-options="label:'施工单位:',readonly:true">
    </div>
