  ...
  function query(){
    ...
    $('#table').datagrid({
      ...
      columns:[[
        ...
        {field:'inspectNo',sortable:true,title:'质检单编号',align:'center',width:'14%'},
        ...
        {field:'additional1',sortable:true,title:'附加1',align:'center',width:'14%'},
        {field:'additional2',sortable:true,title:'附加2',align:'center',width:'14%'},
        {field:'additional3',sortable:true,title:'附加3',align:'center',width:'14%'},
        {field:'additional4',sortable:true,title:'附加4',align:'center',width:'14%'},
