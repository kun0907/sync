...
public class indexDataService extends ActionBase{
	...
	public Map<String, Object> startDesc(List<BigDecimal> START, List<String> y, List<BigDecimal> DNS, List<BigDecimal> Interval, 
							...
							List<BigDecimal> FIN, List<BigDecimal> Delay) {
	...
	public List<String> ipSort(Map<String, Object> map,String file) {
        ...
        Map<String, Object> tcpInfos = (Map<String, Object>) tcpGraph.get("tcpInfos");
        Set<String> ips = tcpInfos.keySet();
        
        List<String> y = new ArrayList<String>();
        List<BigDecimal> START = new ArrayList<BigDecimal>();
        for (String ip : ips) {

        	Map<String, Object> tcpIP = (Map<String, Object>) tcpInfos.get(ip);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<String> ipSort(Map<String, Object> map) {
        ...
        for (String ip : ips) {
            if (ip.equals("tcpGraph") || ip.equals("无效IP") || ip.equals("terminalBrand") 
             || ip.equals("terminalModel")|| ip.equals("logFileData1") || ip.equals("logFileData9"))
                continue;
            Map<String, Object> tcpIP = (Map<String, Object>) map.get(ip);
