...
public class FileInfo {
	...
	private String dnsBigIp="N/A";	//最大DNS时延 ip		（低效）
	private String dnsBig="N/A";	//最大DNS时延
//	private String dnsBigPort;	//最大DNS时延 port	（低效）
	
	private String offTimeBigIp="N/A";	//最大断链时延 ip		（低效）
	private String offTimeBigPort="N/A";	//最大断链时延  port	（低效）
	private String offTimeBig="N/A";	//最大断链时延 
	
	private String timeToFirstBigIp="N/A";	//最大建链后首包时延 ip		（低效）
	private String timeToFirstBigPort="N/A";	//最大建链后首包时延  port	（低效）
	private String timeToFirstBig="N/A";	//最大建链后首包时延
	
	private String tcpTimeBigIp="N/A";	//最大TCP建链时延 ip		（低效）
	private String tcpTimeBigPort="N/A";	//最大TCP建链时延  port	（低效）
	private String tcpTimeBig="N/A";	//最大TCP建链时延 
	
	private String rttTimeBigIp="N/A";	//最大平均RTT时间 ip		（低效）
	private String rttTimeBigPort="N/A";	//最大平均RTT时间  port	（低效）
	private String rttTimeBig="N/A";	//最大平均RTT时间 
	
	private String flowBigIp;//传输量最大IP及端口
	private long flowBigPort;	//传输量最大IP及端口
	private double flowBig;	//传输量
	
	private String exchangeTimeBigIp;//最长交互时间 IP及端口
	private long exchangeTimeBigPort;	//最长交互时间 IP及端口
	private double exchangeTimeBig;	//最长交互时间
	...
	private String avgDnsDelsyTs="N/A";	// log平均DNS时延(ms)
	private String avgTcpTimeDelayed="N/A";	//log平均TCP建链时延(ms)
	private String avgTimeToFirstByte="N/A";	//log平均建链后首包时延(ms)
	private String avgOffTimeDelayed="N/A";	//log平均断链时延(ms)
	private String avgRttTime;	//log平均RTT时间(ms)   平均报文请求响应时间
	private String avgExchangeTime;	//log平均交互时间(ms)
...
//	private GrathVO grath;	
	...
	private int noPermissableParaNum;//不可计算参数个数
	
	private List<List<Integer>> packetLenData;//包长分布
	...
	public List<List<Integer>> getPacketLenData() {
		return packetLenData;
	}
	public void setPacketLenData(List<List<Integer>> packetLenData) {
	...
	public void setServiceIP(List<ServiceIP> serviceIP) {
		...
		if(serviceIP!=null&&serviceIP.size()>0){
			  for (ServiceIP si: serviceIP) {
				     if(si.getUserAgent()!=null){
				    	 this.userAgent=si.getUserAgent();
				    	 break;
				     }
			  }
		}
	...
	public String getOffTimeBigPort() {
		return offTimeBigPort;
	}
	public void setOffTimeBigPort(String offTimeBigPort2) {
	...
	public String getTimeToFirstBigPort() {
		return timeToFirstBigPort;
	}
	public void setTimeToFirstBigPort(String timeToFirstBigPort2) {
	...
	public int getNoPermissableParaNum() {
		return noPermissableParaNum;
	}
	public void setNoPermissableParaNum(int noPermissableParaNum) {
		this.noPermissableParaNum = noPermissableParaNum;
	}
	public String getDnsBig() {
		return dnsBig;
	}
	public void setDnsBig(String dnsBig) {
		this.dnsBig = dnsBig;
	}
	public String getOffTimeBig() {
		return offTimeBig;
	}
	public void setOffTimeBig(String offTimeBig) {
		this.offTimeBig = offTimeBig;
	}
	public String getTimeToFirstBig() {
		return timeToFirstBig;
	}
	public void setTimeToFirstBig(String timeToFirstBig) {
		this.timeToFirstBig = timeToFirstBig;
	}
	public String getTcpTimeBig() {
		return tcpTimeBig;
	}
	public void setTcpTimeBig(String tcpTimeBig) {
		this.tcpTimeBig = tcpTimeBig;
	}
	public String getRttTimeBig() {
		return rttTimeBig;
	}
	public void setRttTimeBig(String rttTimeBig) {
		this.rttTimeBig = rttTimeBig;
	}
	public String getFlowBigIp() {
		return flowBigIp;
	}
	public void setFlowBigIp(String flowBigIp) {
		this.flowBigIp = flowBigIp;
	}
	public long getFlowBigPort() {
		return flowBigPort;
	}
	public void setFlowBigPort(long flowBigPort) {
		this.flowBigPort = flowBigPort;
	}
	public double getFlowBig() {
		return flowBig;
	}
	public void setFlowBig(double flowBig) {
		this.flowBig = flowBig;
	}
	public String getExchangeTimeBigIp() {
		return exchangeTimeBigIp;
	}
	public void setExchangeTimeBigIp(String exchangeTimeBigIp) {
		this.exchangeTimeBigIp = exchangeTimeBigIp;
	}
	public long getExchangeTimeBigPort() {
		return exchangeTimeBigPort;
	}
	public void setExchangeTimeBigPort(long exchangeTimeBigPort) {
		this.exchangeTimeBigPort = exchangeTimeBigPort;
	}
	public double getExchangeTimeBig() {
		return exchangeTimeBig;
	}
	public void setExchangeTimeBig(double exchangeTimeBig) {
		this.exchangeTimeBig = exchangeTimeBig;
	}
}
