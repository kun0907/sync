...
//    	System.out.println(aa.substring(aa.indexOf("@")+1));
    	...
    	*/
    	...
    	System.err.println(Integer.parseInt("0800", 16));
    	System.out.println(0x0800);
       /* Pcap pcap = new Pcap();
        Packet[] packets = pcap.decode("D:\\workspace\\1\\tengxunshipin_taitaiwansui-02.pcap");   // aiqiyi_taitaiwansui-02
        App result = new App(packets, 0);
       ...
       /* String srcImgPath = "C:/Users/renbaokun/Desktop/aa.png";
    	...
    	System.out.println(s.equals(s.substring(0, 19)));*/
    }
    /*** 
